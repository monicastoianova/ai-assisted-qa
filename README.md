...
**Claude Code skills and agents covering application analysis, test planning, and defect reporting** — key stages of the Software Testing Life Cycle applied to OrangeHRM. Every component is validated the way you'd validate any piece of software: expected outcomes predicted first, results checked against ground truth I built or verified myself, and claims verified against raw session logs, not chat summaries.
